...
/**
 * Everything this build knows how to say in ru, in one chunk.
 *
 ...
 * `npm run i18n:check`.
 */
import { ru as core } from "../locales/ru/core";
import { ru as integrations } from "../locales/ru/integrations";
import { ru as sso_clients } from "../locales/ru/sso_clients";
import { ru as storefront } from "../locales/ru/storefront";
import { ru as urtuu } from "../locales/ru/urtuu";
