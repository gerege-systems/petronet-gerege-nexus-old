...
/**
 * Everything this build knows how to say in es, in one chunk.
 *
 ...
 * `npm run i18n:check`.
 */
import { es as core } from "../locales/es/core";
import { es as integrations } from "../locales/es/integrations";
import { es as sso_clients } from "../locales/es/sso_clients";
import { es as storefront } from "../locales/es/storefront";
import { es as urtuu } from "../locales/es/urtuu";
